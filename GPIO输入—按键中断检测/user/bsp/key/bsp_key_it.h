...
//MODE按键
#define CORE_BOARD_MODE_KEY_GPIO          GPIO2
#define CORE_BOARD_MODE_KEY_GPIO_PIN      (17U)
#define CORE_BOARD_MODE_KEY_IOMUXC        IOMUXC_GPIO_EMC_17_GPIO2_IO17
#define CORE_BOARD_MODE_KEY_NAME          "CORE_BORE_MODE_KEY"
#define CORE_BOARD_MODE_KEY_ID            1
//中断相关，IRQ中断号及IRQHandler中断服务函数
#define CORE_BOARD_MODE_KEY_IRQ           GPIO2_Combined_16_31_IRQn
#define CORE_BOARD_MODE_KEY_IRQHandler    GPIO2_Combined_16_31_IRQHandler
